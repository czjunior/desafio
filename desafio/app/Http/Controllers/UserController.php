...
class UserController extends Controller
{
    ...
    public function auth(Request $request) {
        ...
        if(!empty($_POST['g-recaptcha-response'])){
            ...
            //echo "oi aqui ".$resultado->success; exit;
            if($resultado->success == 1){
                ///////////////////////////
            
            if(Auth::attempt(['email' => $request->email, 'password' => $request->password])){
            //return view('users.show', ['search' => '', ])->with('msg', 'Login Efetuado com Sucesso!!!');
            //////////////////////////////
            $user = User::all();
            $perfil = Perfil::all();
            $perfilUsers = PerfilUsers::all();
        ...
        return view('home', 
            ...
            return redirect()->back()->with('danger', 'Os dados informados não conferem!');
        }
                ///////////////////////////
            }else{
                echo "<script>
                alert('Errou o desafio do recaptcha');
                window.location.href = 'https://www.sofs.com.br/desafio/public/';
                </script>";
            }
            
        }else{
                echo "<script>
                alert('Recaptcha deve ser preenchido');
                window.location.href = 'https://www.sofs.com.br/desafio/public/';
                </script>";
...
/*
    ...
    public function updateUsers(Request $request) {
        ...
        return redirect('/users/show')->with('msg', 'Usuário Editado com Sucesso!');
    }
